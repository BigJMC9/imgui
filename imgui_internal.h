...
struct ImGuiContext
{
    ...
    ImGuiNavLayer           NavLayer;                           // EngineInterface we are navigating on. For now the system is hard-coded for 0=main contents and 1=menu/title bar, may expose layers later.
